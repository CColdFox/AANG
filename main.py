...
class Console():        
    def ui(self):
        os.system(f'cls && title /-AANG-/ And Another Nitro Generator | made by CColdFox' if os.name == "nt" else "clear")
        print(center(f"""\n\n
                                                                                                               
                                                                                                               
 █████   █████  ███    ██  ██████  
██   ██ ██   ██ ████   ██ ██         - And Another Nitro Generator -
███████ ███████ ██ ██  ██ ██   ███ 
██   ██ ██   ██ ██  ██ ██ ██    ██       - github.com/CColdFox -
██   ██ ██   ██ ██   ████  ██████  
\n\n
              """).replace('█', Fore.CYAN+"█"+Fore.RESET).replace('~', Fore.CYAN+"~"+Fore.RESET).replace('-', Fore.CYAN+"-"+Fore.RESET))
        print(f" [AANG] > Remember to check out the config before launching the program!")
        print(f" [AANG] > Note that this is a Nitro Generator AND Checker, so it's normal if sometimes it's slow.")
        print(f" [AANG] > Don't tell me that the program doesn't work if you're not putting any proxies/if you use free shitty proxies.")
